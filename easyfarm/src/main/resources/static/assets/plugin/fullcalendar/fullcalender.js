...
!(function (t) {
    ...
    function F(t, e) {
        var n,
            ...
            a = e.start,
            u = e.end;
        if (l > a && o < u) return o >= a ? ((n = o.clone()), (r = !0)) : ((n = a.clone()), (r = !1)), l <= u ? ((i = l.clone()), (s = !0)) : ((i = u.clone()), (s = !1)), { start: n, end: i, isStart: r, isEnd: s };
    }
    function N(t, n) {
    ...
    function Y(t, n) {
        var i;
        return W(t) ? e.duration(t * n) : ((i = t.asMonths()), Math.abs(i) >= 1 && ot(i) ? e.duration({ months: i * n }) : e.duration({ days: t.asDays() * n }));
    }
    function W(t) {
    ...
    function dt(n, i, r) {
        ...
        return (
            e.isMoment(u) || j(u) || void 0 === u
                ? (a = e.apply(null, n))
                : ((s = !1),
                  (o = !1),
                  d ? (Qt.test(u) ? ((u += "-01"), (n = [u]), (s = !0), (o = !0)) : (l = Jt.exec(u)) && ((s = !l[5]), (o = !0))) : t.isArray(u) && (o = !0),
    ...
    function Et(t, e) {
        var n;
        return (
            X(e, "constructor") && (n = e.constructor),
            "function" != typeof n &&
                (n = e.constructor = function () {
    ...
    function Mt(n) {
        ...
        return (
            ...
            i && ((i = "object" == typeof i ? t.extend({}, i) : {}), (r = i.start), null == r && (r = i.time), (s = i.duration), (o = i.stick), delete i.start, delete i.time, delete i.duration, delete i.stick),
    ...
    function Ot(n, i) {
        ...
        function o() {
            n.addClass("fc"),
                ...
                ($ = t("<div class='fc-view-container'/>").prependTo(n)),
                (q = j.header = new _t(j)),
                l(),
                d(j.options.defaultView),
                j.options.handleWindowResize && ((J = at(m, j.options.windowResizeDelay)), t(window).resize(J));
        }
        function l() {
        ...
        function d(e, n) {
            lt++,
                K && e && K.type !== e && (A(), c()),
                !K && e && ((K = j.view = ot[e] || (ot[e] = j.instantiateView(e))), K.setElement(t("<div class='fc-view fc-" + e + "-view' />").appendTo($)), q.activateButton(e)),
                K && ((tt = K.massageCurrentDate(tt)), (K.displaying && tt >= K.intervalStart && tt < K.intervalEnd) || (u() && (K.display(tt, n), O(), H(), T(), E()))),
                O(),
                lt--;
        }
        function c() {
        ...
        function p() {
            ...
            Q =
                "number" == typeof t
                    ...
                    : "parent" === e
                    ? n.parent().height() - v()
                    : Math.round($.width() / Math.max(j.options.aspectRatio, 0.5));
        }
        function v() {
        ...
        (j.render = s),
            (j.destroy = a),
            (j.refetchEvents = y),
            (j.refetchEventSources = S),
            (j.reportEvents = b),
            (j.reportEventChange = C),
            (j.rerenderEvents = w),
            (j.changeView = d),
            (j.select = x),
            (j.unselect = R),
            ...
            (j.viewSpecCache = {}),
            (j.optionHandlers = {}),
            (j.overrides = t.extend({}, i)),
            j.populateOptionsHash();
        var U;
        j.bindOptions(["locale", "monthNames", "monthNamesShort", "dayNames", "dayNamesShort", "firstDay", "weekNumberCalculation"], function (t, e, n, i, s, o, l) {
            ...
            (j.defaultTimedEventDuration = e.duration(j.options.defaultTimedEventDuration)),
            (j.moment = function () {
                var t;
                return (
                    "local" === j.options.timezone
                        ? ((t = jt.moment.apply(null, arguments)), t.hasTime() && t.local())
                        : (t = "UTC" === j.options.timezone ? jt.moment.utc.apply(null, arguments) : jt.moment.parseZone.apply(null, arguments)),
                    r(t),
                    t
                );
            }),
        ...
        (tt = null != j.options.defaultDate ? j.moment(j.options.defaultDate).stripZone() : j.getNow()),
            ...
            (j.freezeContentHeight = A),
            (j.unfreezeContentHeight = O),
            j.initialize();
    }
    function Vt(e) {
                    ...
                    t.each(s.split(" "), function (n) {
                        ...
                        t.each(this.split(","), function (n, i) {
                            ...
                            "title" == i
                                ...
                                : ((s = (r.customButtons || {})[i])
                                      ...
                                      ? ((u = function () {
                                        ...
                                        g.push(i),
                                        (d = a.buttonTextOverride),
                                        (c = a.buttonTextDefault))
                                      : e[i] &&
                                        ((u = function () {
                                            e[i]();
                                        }),
                                        (d = (e.overrides.buttonText || {})[i]),
                                        (c = r.buttonText[i])),
                                  u &&
                                      ((h = s ? s.themeIcon : r.themeButtonIcons[i]),
                                      (p = s ? s.icon : r.buttonIcons[i]),
                                      (v = d ? tt(d) : h && r.theme ? "<span class='ui-icon ui-icon-" + h + "'></span>" : p && !r.theme ? "<span class='fc-icon fc-icon-" + p + "'></span>" : tt(c)),
                                      (m = ["fc-" + i + "-button", f + "-button", f + "-state-default"]),
                                      (y = t('<button type="button" class="' + m.join(" ") + '">' + v + "</button>")
                                          .click(function (t) {
                                              y.hasClass(f + "-state-disabled") || (u(t), (y.hasClass(f + "-state-active") || y.hasClass(f + "-state-disabled")) && y.removeClass(f + "-state-hover"));
                                          })
                                          .mousedown(function () {
                                              y.not("." + f + "-state-active")
                                                  .not("." + f + "-state-disabled")
                                                  .addClass(f + "-state-down");
                                          })
                                          .mouseup(function () {
                            ...
                            l &&
                                o
                                    .first()
                                    .addClass(f + "-corner-left")
                                    .end()
                                    .last()
                                    .addClass(f + "-corner-right")
                                    .end(),
                            o.length > 1 ? ((s = t("<div/>")), l && s.addClass("fc-button-group"), s.append(o), i.append(s)) : i.append(o);
                    }),
                i
            );
        }
    ...
    function Yt() {
        ...
        function a(e, n) {
            ...
            if (o)
                t.isFunction(o)
                    ? (F.pushLoading(),
                      o.call(F, O.clone(), V.clone(), F.options.timezone, function (t) {
                          n(t), F.popLoading();
                      }))
                    : t.isArray(o)
                    ? n(o)
                ...
                if (l) {
                    ...
                    g && (f[g] = O.format()),
                        p && (f[p] = V.format()),
                        F.options.timezone && "local" != F.options.timezone && (f[v] = F.options.timezone),
                        F.pushLoading(),
                        t.ajax(
                            t.extend({}, Te, e, {
                                data: f,
        ...
        function H(e) {
            ...
            for (
                ...
                t.isArray(Y[i].events) && (Y[i].events = t.grep(Y[i].events, e, !0));
            P(j);
        }
        function T(e) {
        ...
        function R(n, i) {
            var r,
                ...
                l = {};
            if (
                (F.options.eventDataTransform && (n = F.options.eventDataTransform(n)),
                i && i.eventDataTransform && (n = i.eventDataTransform(n)),
                t.extend(l, n),
                i && (l.source = i),
                (l._id = n._id || (void 0 === n.id ? "_fc" + xe++ : n.id + "")),
        ...
        function M(t) {
            null == t.allDay && (t.allDay = !(t.start.hasTime() || (t.end && t.end.hasTime()))),
                t.allDay ? (t.start.stripTime(), t.end && t.end.stripTime()) : (t.start.hasTime() || (t.start = F.applyTimezone(t.start.time(0))), t.end && !t.end.hasTime() && (t.end = F.applyTimezone(t.end.time(0))));
        }
        function L(e, n, i) {
            var r,
                s,
            ...
            if (((n = n || O), (i = i || V), e))
                if (e._recurring) {
                    ...
                    for (l = n.clone().stripTime(); l.isBefore(i); )
                        (r && !r[l.day()]) || ((a = e.start), (u = e.end), (d = l.clone()), (c = null), a && (d = d.time(a)), u && (c = l.clone().time(u)), (h = t.extend({}, e)), I(d, c, !a && !u, h), f.push(h)), l.add(1, "days");
                } else f.push(e);
            return f;
        }
        function B(e, n, i) {
            ...
            return (
                ...
                k(n),
                (s = { start: e._start.clone(), end: e._end ? e._end.clone() : F.getDefaultEventEnd(e._allDay, e._start), allDay: n.allDay }),
                k(s),
                ...
                { dateDelta: l, durationDelta: u, undo: d }
            );
        }
        function z(e, n, i, r, s, o) {
            ...
            return (
                ...
                t.each(e, function (e, u) {
                    var d, c;
                    (d = { start: u.start.clone(), end: u.end ? u.end.clone() : null, allDay: u.allDay }),
                        t.each(o, function (t) {
                            d[t] = u[t];
                        }),
                        (c = { start: u._start, end: u._end, allDay: i }),
                        k(c),
                        n ? (c.end = null) : s && !c.end && (c.end = F.getDefaultEventEnd(c.allDay, c.start)),
                        r && (c.start.add(r), c.end && c.end.add(r)),
                        s && c.end.add(s),
                        l && !c.allDay && (r || s) && (c.start.stripZone(), c.end && c.end.stripZone()),
                        t.extend(u, o, c),
                        Wt(u),
                        a.push(function () {
                            t.extend(u, d), Wt(u);
        ...
        (F.isFetchNeeded = n),
            (F.fetchEvents = i),
            (F.fetchEventSources = r),
            (F.getEventSources = g),
            (F.getEventSourceById = p),
            (F.getEventSourcesByMatchArray = v),
            (F.getEventSourcesByMatch = m),
            (F.addEventSource = u),
            (F.removeEventSource = c),
            (F.removeEventSources = h),
            (F.updateEvent = E),
            (F.renderEvent = C),
            (F.removeEvents = H),
            (F.clientEvents = T),
            (F.mutateEvent = B),
            (F.normalizeEventDates = k),
        ...
        t.each((F.options.events ? [F.options.events] : []).concat(F.options.eventSources || []), function (t, e) {
            ...
            (F.buildEventFromInput = R),
            (F.expandEvent = L),
            (F.getEventCache = function () {
                return j;
            });
    }
    function Wt(t) {
    ...
    var jt = (t.fullCalendar = { version: "3.0.1", internalApiVersion: 6 }),
        Ut = (jt.views = {});
    ...
    (jt.intersectRanges = F),
        ...
        (jt.cssToStr = nt),
        (jt.proxy = lt),
        (jt.capitaliseFirstLetter = rt),
        (jt.getOuterRect = h),
        (jt.getClientRect = f),
        (jt.getContentRect = g),
        (jt.getScrollbarWidths = p);
    var Zt = null;
    (jt.preventDefault = C),
        (jt.intersectRects = x),
        (jt.parseFieldSpecs = M),
        (jt.compareByFieldSpecs = L),
        (jt.compareByFieldSpec = B),
        (jt.flexibleCompare = z),
        (jt.computeIntervalUnit = O),
        (jt.divideRangeByDuration = P),
        (jt.divideDurationByDuration = _),
        (jt.multiplyDuration = Y),
        (jt.durationHasTime = W);
    ...
    var re = { Y: "year", M: "month", D: "day", d: "day", A: "second", a: "second", T: "second", t: "second", H: "second", h: "second", m: "second", s: "second" },
        se = {},
        oe = { Y: { value: 1, unit: "year" }, M: { value: 2, unit: "month" }, W: { value: 3, unit: "week" }, w: { value: 3, unit: "week" }, D: { value: 4, unit: "day" }, d: { value: 4, unit: "day" } };
    ...
    var le = (jt.EmitterMixin = {
        ...
        de = wt.extend(ae, {
            ...
            render: function () {
                var e = this,
                    n = this.options;
                (this.el = t('<div class="fc-popover"/>')
            ...
            position: function () {
                ...
                (r = o.top || 0),
                    ...
                    h.is(window) || h.is(document) ? ((h = d), (e = 0), (n = 0)) : ((i = h.offset()), (e = i.top), (n = i.left)),
                    (e += d.scrollTop()),
                    (n += d.scrollLeft()),
                    o.viewportConstrain !== !1 && ((r = Math.min(r, e + h.outerHeight() - u - this.margin)), (r = Math.max(r, e + this.margin)), (s = Math.min(s, n + h.outerWidth() - a - this.margin)), (s = Math.max(s, n + this.margin))),
            ...
            bindHandlers: function () {
                ...
                this.isTouch
                    ? (this.listenTo(t(document), {
                      ...
                      !H(this.handleTouchScrollProxy) && this.scrollEl && this.listenTo(this.scrollEl, "scroll", this.handleTouchScroll))
    ...
    he.mixin({
        ...
        setScrollVel: function (t, e) {
            (this.scrollTopVel = t),
                ...
                (!this.scrollTopVel && !this.scrollLeftVel) || this.scrollIntervalId || (this.scrollIntervalId = setInterval(lt(this, "scrollIntervalFunc"), this.scrollIntervalMs));
        },
    ...
    var fe = he.extend({
                ...
                this.computeCoords(),
                    t
                        ? ((n = { left: w(t), top: E(t) }),
                          ...
                          r && this.options.subjectCenter && (this.origHit && (e = x(this.origHit, e) || e), (i = I(e))),
        ...
        ge = wt.extend(ae, {
            ...
            start: function (e) {
                this.isFollowing ||
                    ...
                    D(e) ? this.listenTo(t(document), "touchmove", this.handleMove) : this.listenTo(t(document), "mousemove", this.handleMove));
            },
            stop: function (e, n) {
                function i() {
                ...
                this.isFollowing &&
                    !this.isAnimating &&
                    ((this.isFollowing = !1), this.stopListeningTo(t(document)), e && s && !this.isHidden ? ((this.isAnimating = !0), this.el.animate({ top: this.top0, left: this.left0 }, { duration: s, complete: i })) : i());
            },
            getEl: function () {
                var t = this.el;
                return (
        ...
        pe = (jt.Grid = wt.extend(ae, ue, {
            ...
            dayTouchStart: function (t) {
                var e = this.view;
                (e.isSelected || e.selectedEvent) && this.tempIgnoreMouse(), this.dayDragListener.startInteraction(t, { delay: this.view.opt("longPressDelay") });
            },
            ...
            getDayClasses: function (t) {
                var e = this.view,
                    ...
                    i = ["fc-" + $t[t.day()]];
                return (
                    1 == e.intervalDuration.as("months") && t.month() != e.intervalStart.month() && i.push("fc-other-month"),
    ...
    pe.mixin({
        ...
        buildBusinessHourSegs: function (e) {
            ...
            return !n.length && this.view.calendar.options.businessHours && (n = [t.extend({}, Re, { start: this.view.end, end: this.view.end, dow: null })]), this.eventsToSegs(n);
        },
        ...
        handleSegMouseout: function (t, e) {
            (e = e || {}),
                this.mousedOverSeg && ((t = t || this.mousedOverSeg), (this.mousedOverSeg = null), this.view.isEventResizable(t.event) && t.el.removeClass("fc-allow-mouse-resize"), this.view.trigger("eventMouseout", t.el[0], t.event, e));
        },
        ...
        handleSegTouchStart: function (t, e) {
            var n,
                ...
                a = !1;
            s && l && (a = this.startSegResize(t, e)),
                a || (!o && !l) || ((n = o ? this.buildSegDragListener(t) : this.buildSegSelectListener(t)), n.startInteraction(e, { delay: s ? 0 : this.view.opt("longPressDelay") })),
        ...
        buildSegDragListener: function (t) {
            ...
            var c = (this.segDragListener = new fe(l, {
                ...
                interactionStart: function (i) {
                    (t.component = r),
                        (e = !1),
                        (n = new ge(t.el, { additionalClass: "fc-dragging", parentEl: l.el, opacity: c.isTouch ? null : l.opt("dragOpacity"), revertDuration: l.opt("dragRevertDuration"), zIndex: 2 })),
                        n.hide(),
                        n.start(i);
                },
                ...
                hitOver: function (e, o, u) {
                    var h;
                    t.hit && (u = t.hit),
                        (i = r.computeEventDrop(u.component.getHitSpan(u), e.component.getHitSpan(e), d)),
                        i && !a.isEventSpanAllowed(r.eventToSpan(i), d) && (s(), (i = null)),
                        i && (h = l.renderDrag(i, t)) ? (h.addClass("fc-dragging"), c.isTouch || r.applyDragOpacity(h), n.hide()) : n.show(),
                        o && (i = null);
                },
                hitOut: function () {
        ...
        computeEventDrop: function (t, e, n) {
            ...
            return (
                o.hasTime() === l.hasTime()
                    ? ((i = this.diffDates(l, o)), n.allDay && W(i) ? ((r = { start: n.start.clone(), end: s.getEventEnd(n), allDay: !1 }), s.normalizeEventTimes(r)) : (r = Ht(n)), r.start.add(i), r.end && r.end.add(i))
                ...
                h = (this.segResizeListener = new fe(this, {
                    ...
                    hitOver: function (n, o, u) {
                        var h = r.getHitSpan(u),
                            f = r.getHitSpan(n);
                        (i = e ? r.computeEventStartResize(h, f, d) : r.computeEventEndResize(h, f, d)),
                            i && (a.isEventSpanAllowed(r.eventToSpan(i), d) ? i.start.isSame(d.start.clone().stripZone()) && i.end.isSame(c.clone().stripZone()) && (i = null) : (s(), (i = null))),
                            i && (l.hideEvent(d), r.renderEventResize(i, t));
                    },
                    hitOut: function () {
                        i = null;
                    },
        ...
        computeEventResize: function (t, e, n, i) {
            ...
            return (
                ...
                r[t].add(l),
                r.start.isBefore(r.end) || ((s = this.minResizeDuration || (i.allDay ? o.defaultAllDayEventDuration : o.defaultTimedEventDuration)), "start" == t ? (r.start = r.end.clone().subtract(s)) : (r.end = r.start.clone().add(s))),
                r
            );
        },
        ...
        invertRanges: function (t) {
            var e,
                ...
                o = [],
                l = r;
            for (t.sort(kt), e = 0; e < t.length; e++) (n = t[e]), n.start > l && o.push({ start: l, end: n.start }), (l = n.end);
    ...
    var ve = (jt.DayTableMixin = {
            ...
            updateDayTable: function () {
                for (var t, e, n, i = this.view, r = this.start.clone(), s = -1, o = [], l = []; r.isBefore(this.end); ) i.isHiddenDay(r) ? o.push(s + 0.5) : (s++, o.push(s), l.push(r.clone())), r.add(1, "days");
            ...
            sliceRangeByRow: function (t) {
                ...
                for (e = 0; e < this.rowCnt; e++)
                    (n = e * o),
                        ...
                        (r = Math.ceil(r)),
                        (s = Math.floor(s)),
                        r <= s && d.push({ row: e, firstRowDayIndex: r - n, lastRowDayIndex: s - n, isStart: r === a, isEnd: s === u });
                return d;
            },
            sliceRangeByDay: function (t) {
                ...
                for (e = 0; e < this.rowCnt; e++)
                    for (n = e * l, i = n + l - 1, r = n; r <= i; r++)
                        (s = Math.max(u, r)), (o = Math.min(d, r)), (s = Math.ceil(s)), (o = Math.floor(o)), s <= o && c.push({ row: e, firstRowDayIndex: s - n, lastRowDayIndex: o - n, isStart: s === u, isEnd: o === d });
                return c;
            },
            ...
            renderHeadDateCellHtml: function (t, e, n) {
                ...
                return (
                    ...
                    $t[t.day()] +
                    '"' +
                    (1 === this.rowCnt ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") +
                    (e > 1 ? ' colspan="' + e + '"' : "") +
                    (n ? " " + n : "") +
                    ">" +
        ...
        me = (jt.DayGrid = pe.extend(ve, {
            ...
            renderDates: function (t) {
                ...
                for (
                    this.el.html(o),
                        ...
                        this.rowCoordCache = new ce({ els: this.rowEls, isVertical: !0 }),
                        this.colCoordCache = new ce({ els: this.cellEls.slice(0, this.colCnt), isHorizontal: !0 }),
                        e = 0;
                    e < r;
                    e++
                )
            ...
            renderDayRowHtml: function (t, e) {
                ...
                return (
                    ...
                    '<div class="' +
                        ...
                        (this.numbersVisible ? "<thead>" + this.renderNumberTrHtml(t) + "</thead>" : "") +
                        "</table></div></div>"
                );
            },
            ...
            renderNumberCellHtml: function (t) {
                ...
                return this.view.dayNumbersVisible || this.view.cellWeekNumbersVisible
                    ? ((e = this.getDayClasses(t)),
                      ...
                      (i += '<td class="' + e.join(" ") + '" data-date="' + t.format() + '">'),
                      this.view.cellWeekNumbersVisible && t.day() == n && (i += this.view.buildGotoAnchorHtml({ date: t, type: "week" }, { class: "fc-week-number" }, t.format("w"))),
            ...
            renderFillRow: function (e, n, i) {
                ...
                return (
                    (i = i || e.toLowerCase()),
                    (r = t('<div class="fc-' + i + '-skeleton"><table><tr/></table></div>')),
                    (s = r.find("tr")),
                    l > 0 && s.append('<td colspan="' + l + '"/>'),
                    s.append(n.el.attr("colspan", a - l)),
                    a < o && s.append('<td colspan="' + (o - a) + '"/>'),
                    this.bookendCells(s),
                    r
                );
            },
    ...
    me.mixin({
        ...
        fgSegHtml: function (t, e) {
            ...
            return (
                ...
                t.isStart && ((n = this.getEventTimeText(s)), n && (c = '<span class="fc-time">' + tt(n) + "</span>")),
                (i = '<span class="fc-title">' + (tt(s.title || "") || "&nbsp;") + "</span>"),
                '<a class="' +
                    u.join(" ") +
                    '"' +
                    (s.url ? ' href="' + tt(s.url) + '"' : "") +
                    ...
                    (a ? '<div class="fc-resizer fc-end-resizer" />' : "") +
                    "</a>"
            );
        },
            ...
            for (r = 0; r < f; r++) {
                if (((s = h[r]), (o = 0), (l = t("<tr/>")), p.push([]), v.push([]), m.push([]), s))
                    for (a = 0; a < s.length; a++) {
                        for (u = s[a], i(u.leftCol), d = t('<td class="fc-event-container"/>').append(u.el), u.leftCol != u.rightCol ? d.attr("colspan", u.rightCol - u.leftCol + 1) : (m[r][o] = d); o <= u.rightCol; )
                            (v[r][o] = d), (p[r][o] = u), o++;
                        l.append(d);
                    }
            ...
            limitRow: function (e, n) {
                ...
                if (n && n < w.segLevels.length) {
                    for (r = w.segLevels[n - 1], s = w.cellMatrix, o = w.tbodyEl.children().slice(n).addClass("fc-limited").get(), l = 0; l < r.length; l++) {
                        ...
                        if (d) {
                            for (h = s[n - 1][a.leftCol], f = h.attr("rowspan") || 1, g = [], p = 0; p < c.length; p++)
                                (v = t('<td class="fc-more-cell"/>').attr("rowspan", f)), (u = c[p]), (y = this.renderMoreLink(e, a.leftCol + p, [a].concat(u))), (m = t("<div/>").append(y)), v.append(m), g.push(v[0]), E.push(v[0]);
            ...
            renderMoreLink: function (e, n, i) {
                ...
                return t('<a class="fc-more"/>')
                    ...
                    .on("click", function (o) {
                        ...
                        "function" == typeof l && (l = s.trigger("eventLimitClick", null, { date: a, dayEl: d, moreEl: u, segs: h, hiddenSegs: f }, o)),
    ...
    var ye = (jt.TimeGrid = pe.extend(ve, {
        ...
        renderDates: function () {
            this.el.html(this.renderHtml()),
                ...
                (this.colCoordCache = new ce({ els: this.colEls, isHorizontal: !0 })),
                (this.slatCoordCache = new ce({ els: this.slatEls, isVertical: !0 })),
        ...
        renderSlatRowHtml: function () {
            for (var t, n, i, r = this.view, s = this.isRTL, o = "", l = e.duration(+this.minTime); l < this.maxTime; )
                (t = this.start.clone().time(l)),
                    ...
                    (i = '<td class="fc-axis fc-time ' + r.widgetContentClass + '" ' + r.axisStyleAttr() + ">" + (n ? "<span>" + tt(t.format(this.labelFormat)) + "</span>" : "") + "</td>"),
            ...
            if (i.isLeftInBounds(t) && r.isTopInBounds(e)) {
                ...
                if (null != s && null != o) {
                    var l = r.getTopOffset(o),
                        ...
                        h = l + (d / n) * a,
                        f = l + ((d + 1) / n) * a;
                    return { col: s, snap: c, component: this, left: i.getLeftOffset(s), right: i.getRightOffset(s), top: h, bottom: f };
                }
            }
        },
        getHitSpan: function (t) {
    ...
    ye.mixin({
        ...
        fgSegHtml: function (t, e) {
            ...
            return (
                d.unshift("fc-time-grid-event", "fc-v-event"),
                s.isMultiDayEvent(o)
                    ? (t.isStart || t.isEnd) && ((n = this.getEventTimeText(t)), (i = this.getEventTimeText(t, "LT")), (r = this.getEventTimeText(t, null, !1)))
                ...
                '<a class="' +
                    ...
                    (c ? ' style="' + c + '"' : "") +
                    '><div class="fc-content">' +
                    (n ? '<div class="fc-time" data-start="' + tt(r) + '" data-full="' + tt(i) + '"><span>' + tt(n) + "</span></div>" : "") +
                    (o.title ? '<div class="fc-title">' + tt(o.title) + "</div>" : "") +
                    '</div><div class="fc-bg"/>' +
        ...
        computeFgSegForwardBack: function (t, e, n) {
            ...
            if (void 0 === t.forwardCoord)
                for (
                    r.length ? (this.sortForwardSegs(r), this.computeFgSegForwardBack(r[0], e + 1, n), (t.forwardCoord = r[0].backwardCoord)) : (t.forwardCoord = 1), t.backwardCoord = t.forwardCoord - (t.forwardCoord - n) / (e + 1), i = 0;
                    i < r.length;
                    i++
                )
    ...
    var Se = (jt.View = wt.extend(le, ae, {
            ...
            constructor: function (t, n, i, r) {
                (this.calendar = t),
                    ...
                    (this.eventOrderSpecs = M(this.opt("eventOrder"))),
                    this.initialize();
            },
            initialize: function () {},
            opt: function (t) {
            ...
            computeRange: function (t) {
                ...
                return (
                    /year|month|week|day/.test(i) ? (r.stripTime(), s.stripTime()) : (r.hasTime() || (r = this.calendar.time(0)), s.hasTime() || (s = this.calendar.time(0))),
                    (e = r.clone()),
            ...
            display: function (t, e) {
                var n = this,
                    i = null;
                return (
                    null != e && this.displaying && (i = this.queryScroll()),
            ...
            computeDayRange: function (t) {
                var e,
                    ...
                    i = t.end,
                    r = null;
                return i && ((r = i.clone().stripTime()), (e = +i.time()), e && e >= this.nextDayThreshold && r.add(1, "days")), (!i || r <= n) && (r = n.clone().add(1, "days")), { start: n, end: r };
            },
        ...
        Ee = (jt.Calendar = wt.extend({
            ...
            buildViewSpec: function (t) {
                for (var i, r, s, o, l = this.overrides.views || {}, a = [], u = [], d = [], c = t; c; )
                    (i = Ut[c]),
                        (r = l[c]),
                        (c = null),
                ...
                return (
                    ...
                    (i.type = t),
                    !!i.class &&
                        (s && ((s = e.duration(s)), s.valueOf() && ((i.duration = s), (o = O(s)), 1 === s.as(o) && ((i.singleUnit = o), d.unshift(l[o] || {})))),
                        (i.defaults = n(u)),
                        (i.overrides = n(d)),
    ...
    Ee.mixin(le),
        ...
        (Ee.englishDefaults = { dayPopoverFormat: "dddd, MMMM D" }),
        (Ee.rtlDefaults = {
    ...
    var Te = { dataType: "json", cache: !1 },
        xe = 1;
    (Ee.prototype.normalizeEvent = function (t) {}),
        (Ee.prototype.spanContainsSpan = function (t, e) {
    ...
    var Re = { id: "_fcBusinessHours", start: "09:00", end: "17:00", dow: [1, 2, 3, 4, 5], rendering: "inverse-background" };
    ...
    var Ie = (jt.BasicView = Se.extend({
            ...
            headRowEl: null,
            initialize: function () {
                (this.dayGrid = this.instantiateDayGrid()), (this.scroller = new we({ overflowX: "hidden", overflowY: "auto" }));
            },
            ...
            renderDates: function () {
                (this.dayNumbersVisible = this.dayGrid.rowCnt > 1),
                    this.opt("weekNumbers") && (this.opt("weekNumbersWithinDays") ? ((this.cellWeekNumbersVisible = !0), (this.colWeekNumbersVisible = !1)) : ((this.cellWeekNumbersVisible = !1), (this.colWeekNumbersVisible = !0))),
            ...
            setHeight: function (t, e) {
                ...
                this.scroller.clear(),
                    ...
                    o && "number" != typeof o && this.dayGrid.limitRows(o),
                    e || (this.scroller.setHeight(n), (s = this.scroller.getScrollbarWidths()), (s.left || s.right) && (i(this.headRowEl, s), (n = this.computeScrollerHeight(t)), this.scroller.setHeight(n)), this.scroller.lockOverflow(s));
            },
    ...
    (Ut.basic = { class: Ie }), (Ut.basicDay = { type: "basic", duration: { days: 1 } }), (Ut.basicWeek = { type: "basic", duration: { weeks: 1 } }), (Ut.month = { class: Me, duration: { months: 1 }, defaults: { fixedWeekCount: !0 } });
    var Le = (jt.AgendaView = Se.extend({
            ...
            bottomRuleEl: null,
            initialize: function () {
                (this.timeGrid = this.instantiateTimeGrid()), this.opt("allDaySlot") && (this.dayGrid = this.instantiateDayGrid()), (this.scroller = new we({ overflowX: "hidden", overflowY: "auto" }));
            },
            ...
            setHeight: function (t, e) {
                ...
                this.bottomRuleEl.hide(),
                    ...
                    this.dayGrid && (this.dayGrid.removeSegPopover(), (n = this.opt("eventLimit")), n && "number" != typeof n && (n = Fe), n && this.dayGrid.limitRows(n)),
                    e ||
            ...
            renderHeadIntroHtml: function () {
                ...
                return e.opt("weekNumbers")
                    ? ((t = this.start.format(e.opt("smallWeekFormat"))),
                      '<th class="fc-axis fc-week-number ' + e.widgetHeaderClass + '" ' + e.axisStyleAttr() + ">" + e.buildGotoAnchorHtml({ date: this.start, type: "week", forceOff: this.colCnt > 1 }, tt(t)) + "</th>")
                    : '<th class="fc-axis ' + e.widgetHeaderClass + '" ' + e.axisStyleAttr() + "></th>";
            },
            renderBgIntroHtml: function () {
                var t = this.view;
    ...
    (Ut.agenda = { class: Le, defaults: { allDaySlot: !0, slotDuration: "00:30:00", minTime: "00:00:00", maxTime: "24:00:00", slotEventOverlap: !0 } }),
        (Ut.agendaDay = { type: "agenda", duration: { days: 1 } }),
        (Ut.agendaWeek = { type: "agenda", duration: { weeks: 1 } });
    var Ge = Se.extend({
            grid: null,
            scroller: null,
            initialize: function () {
                (this.grid = new Ae(this)), (this.scroller = new we({ overflowX: "hidden", overflowY: "auto" }));
            },
            setRange: function (t) {
        ...
        Ae = pe.extend({
            ...
            dayHeaderHtml: function (t) {
                ...
                return (
                    ...
                    e.widgetHeaderClass +
                    '" colspan="3">' +
                    (n ? e.buildGotoAnchorHtml(t, { class: "fc-list-heading-main" }, tt(t.format(n))) : "") +
                    (i ? e.buildGotoAnchorHtml(t, { class: "fc-list-heading-alt" }, tt(t.format(i))) : "") +
                    "</td></tr>"
                );
            },
            fgSegHtml: function (t) {
                var e,
                    ...
                    o = s.url;
                return (
                    (e = s.allDay ? n.getAllDayHtml() : n.isMultiDayEvent(s) ? (t.isStart || t.isEnd ? tt(this.getEventTimeText(t)) : n.getAllDayHtml()) : tt(this.getEventTimeText(s))),
                    o && i.push("fc-has-url"),
                    '<tr class="' +
                        i.join(" ") +
                        '">' +
                        (this.displayEventTime ? '<td class="fc-list-item-time ' + n.widgetContentClass + '">' + (e || "") + "</td>" : "") +
                        '<td class="fc-list-item-marker ' +
                        n.widgetContentClass +
    ...
    return (
        (Ut.list = { class: Ge, buttonTextKey: "list", defaults: { buttonText: "list", listDayFormat: "LL", noEventsMessage: "No events to display" } }),
        (Ut.listDay = { type: "list", duration: { days: 1 }, defaults: { listDayFormat: "dddd" } }),
        (Ut.listWeek = { type: "list", duration: { weeks: 1 }, defaults: { listDayFormat: "dddd", listDayAltFormat: "LL" } }),
        (Ut.listMonth = { type: "list", duration: { month: 1 }, defaults: { listDayAltFormat: "dddd" } }),
        (Ut.listYear = { type: "list", duration: { year: 1 }, defaults: { listDayAltFormat: "dddd" } }),
        jt
    );
});
